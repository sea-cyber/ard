...
import com.project.framework.config.properties.PermitAllUrlProperties;
import com.project.framework.security.filter.JwtAuthenticationTokenFilter;
        ...
        return httpSecurity
            ...
            .authorizeHttpRequests((requests) -> {
                ...
                requests.antMatchers("/login", "/register", "/captchaImage").permitAll()
                    ...
                    // 资源预览与下载接口匿名访问
                    .antMatchers(HttpMethod.GET, "/common/view/resource", "/common/download/resource").permitAll()
                    // 预检请求放行
